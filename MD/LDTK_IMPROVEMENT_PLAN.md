...
- [x] **Review `LdtkMap` Structs**: Verify `ecs/src/components/ldtk_map.rs` matches the latest LDtk JSON schema, particularly for `LayerInstance` and `EntityInstance`.
- [x] **Refactor `ldtk_loader.rs`**: 
