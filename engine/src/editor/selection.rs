...
impl SelectionManager {
    ...
    pub fn finish_box_selection(&mut self, world: &World, scene_camera: &crate::editor::SceneCamera, center: egui::Pos2) -> Vec<Entity> {
    ...
    fn get_entities_in_rect(
        ...
        rect: egui::Rect,
        world: &World,
        scene_camera: &crate::editor::SceneCamera,
        center: egui::Pos2,
    ) -> Vec<Entity> {
